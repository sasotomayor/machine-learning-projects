...
train_bow_features_nobin = p1.extract_bow_feature_vectors(train_texts, dictionary, False)
val_bow_features_nobin = p1.extract_bow_feature_vectors(val_texts, dictionary, False)
test_bow_features_nobin = p1.extract_bow_feature_vectors(test_texts, dictionary, False)
...
#-------------------------------------------------------------------------------
# Changing bag of words. Removing stopwords.
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# Changing extract_bow_feature_vectors. Option to no binary feature matrix.
#-------------------------------------------------------------------------------
...
avg_peg_train_accuracy, avg_peg_test_accuracy = \
   p1.classifier_accuracy(p1.pegasos, train_bow_features_nobin, test_bow_features_nobin, train_labels, test_labels, T=T, L=L)
print("{:50} {:.4f}".format("Test accuracy for Pegasos:", avg_peg_test_accuracy))