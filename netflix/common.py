...
def bic(X: np.ndarray, mixture: GaussianMixture,
    ...
    free_parameters = mixture.mu.shape[0]*mixture.mu.shape[1] + mixture.var.shape[0] + mixture.p.shape[0] - 1
    return log_likelihood - 0.5*free_parameters*np.log(X.shape[0])
